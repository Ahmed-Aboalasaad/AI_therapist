...
class LlmTestRequest(BaseModel):
    ...
    emotion: str = Field(..., description="The classified emotion.")
    intent: str = Field(..., description="The classified intent.")
    context: Optional[str] = Field(default="", description="Optional context snippet.")
    language: Optional[str] = Field(default="English", description="Optional language parameter.")
    session_id: Optional[str] = Field(default="default-session", description="Optional session identifier.")
